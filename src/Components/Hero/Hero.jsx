      ...
      <div className={`${styles.hero} container`}>
        <div className={styles.hero_content}>
          ...
          <div className={styles.description}>
            I'm a front-end enthusiast with 3+ years of experience building
            sleek, user-friendly interfaces in React. Whether it's transforming
            design files into interactive experiences or optimizing for
            performance, I strive to create seamless digital experiences that
